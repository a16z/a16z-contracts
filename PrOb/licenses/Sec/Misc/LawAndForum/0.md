...
Explode.sec=<ol><li>{Am.Sec}</li><li>{Arb.Sec}</li><li>{Fee.Sec}</li><li>{Law.Sec}</li><li>{Class.Sec}</li><li>{CA.Sec}</li></ol>

Am.Ti=Amical Resolution

Am.sec=<ol><li>{AmicalResolution.sec}</li><li>{NoticePeriod.sec}</li></ol>
